...
const FIELD_MAPS: Record<string, any> = {
  ...
  mecklenburg: {
    ...
    deed_date: ["DEEDDATE", "RECORDED_DATE", "deeddate", "recorded_date"],
    sale_date: ["SALEDATE", "SALE_DATE", "saledate", "sale_date"],
    totsalprice: "parval",
    owner_name: "ownname",
    owner_mailing_1: ["mailadd", "MAILADD"],
    city: "scity",
    zip_code: ["SITEZIP", "SITE_ZIP", "SZIP", "szip", "MZIP", "mzip", "ZIP", "ZIPCODE"],
    land_code: null,
